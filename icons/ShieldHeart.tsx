...
const SvgShieldHeart = ({
  ...
  <Svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-shield-heart"
    {...props}
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
    <Path d="M12 21A12 12 0 0 1 3.5 6 12 12 0 0 0 12 3a12 12 0 0 0 8.5 3 12 12 0 0 1 .378 5" />
