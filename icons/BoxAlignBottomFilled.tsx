...
const SvgBoxAlignBottomFilled = ({
  ...
  <Svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-box-align-bottom-filled"
    {...props}
  >
