...
const SvgSettingsSearch = ({
  ...
  <svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-settings-search"
    {...props}
  >
    ...
    <path d="M14.985 11.694a3 3 0 1 0-3.29 3.29M15 18a3 3 0 1 0 6 0 3 3 0 1 0-6 0M20.2 20.2 22 22" />
  </svg>
);
