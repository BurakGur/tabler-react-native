...
const SvgFileXFilled = ({
  ...
  <svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-file-x-filled"
    {...props}
  >
    ...
    />
    <path fill="currentColor" stroke="none" d="M19 7h-4l-.001-4.001z" />
  </svg>
);
export default SvgFileXFilled;
