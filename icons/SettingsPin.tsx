...
const SvgSettingsPin = ({
  ...
  <svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-settings-pin"
    {...props}
  >
    ...
    <path d="M14.99 12.256a3 3 0 1 0-2.33 2.671M21.121 20.121a3 3 0 1 0-4.242 0Q17.506 20.749 19 22q1.577-1.335 2.121-1.879M19 18v.01" />
  </svg>
);
