...
const SvgSquareRoundedChevronDownFilled = ({
  size = 24,
  stroke = 2,
  color = "currentColor",
}: {
  ...
  <Svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-square-rounded-chevron-down-filled"
    {...props}
  >
...
export default SvgSquareRoundedChevronDownFilled;
