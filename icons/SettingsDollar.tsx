...
const SvgSettingsDollar = ({
  ...
  <Svg
    ...
    strokeWidth={stroke}
    className="icon icon-tabler icon-tabler-settings-dollar"
    {...props}
  >
    ...
    <Path d="M15 12a3 3 0 1 0-1.724 2.716M21 15h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H17M19 21v1m0-8v1" />
  </Svg>
);
